		...
		<div class="box-content">
			...
			<form class="form-horizontal" method="post" action="">
			  <fieldset>
				...
				<div class="control-group">
				  <label class="control-label" for="kind">Name Kind:</label>
				  <div class="controls" >
					<input name="kind_name" type="text" id="kind" placeholder="Name Kind..." value="<?php echo set_value('kind_name'); ?>" />
				  </div>
				</div>
...
<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
		<div class="box-header" data-original-title="">
			<h2><i class="halflings-icon white edit"></i><span class="break"></span>List kind</h2>
			<div class="box-icon">
				<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
				<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
				<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
			...
			<table class="table table-striped table-bordered bootstrap-datatable datatable dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
				<thead>
					<tr role="row">
						...
						<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Date registered: activate to sort column ascending" style="width: 248px;">Kind Name</th>
							...
							foreach($data as $key => $value)
							{
								echo'<tr class="odd">
									...
									<td class="center ">
										...
										<a class="btn btn-info" href="index.php/admin/kind/edit/'.$value['id'].'">
											<i class="halflings-icon white edit"></i>  
										</a>
										<a class="btn btn-danger" href="index.php/admin/kind/del/'.$value['id'].'">
