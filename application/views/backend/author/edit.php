				...
				<?php
					if(isset($data) && !empty($data))
					{
						echo '<div class="control-group">
						  ...
						  <div class="controls" >
							<input class="span6" name="author_name" type="text" id="author" placeholder="Author name..." value="'.$data['name'].'" />
						  </div>
						</div>
						<div class="control-group">
						  <label class="control-label" for="author">Born:</label>
						  <div class="controls" >
							<input name="author_born" type="date" id="author" max="'.date("d/m/Y").'" value="'.$data['born'].'" />
						  </div>
						</div>
						<div class="control-group">
						  <label class="control-label" for="author">Field:</label>
						  <div class="controls" >
							<input name="author_field" type="text" id="author" placeholder="Field..." value="'.$data['field'].'" />
						  </div>
						</div>
						<div class="control-group">
